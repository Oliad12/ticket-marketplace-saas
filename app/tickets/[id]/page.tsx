...
import ListForResale from "@/components/ListForResale";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Resale Option */}
        {ticket.status === "valid" && !ticket.event.is_cancelled && (
          <div className="mt-6">
            <ListForResale ticketId={ticket._id} eventId={ticket.eventId} />
          </div>
        )}
