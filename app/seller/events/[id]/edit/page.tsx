        ...
        <div className="p-6">
          ...
          <div className="mt-8 border-t border-gray-200 pt-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Add VIP, General, Student or other ticket tiers with different prices and quantities.
            </p>
            <TicketTypeManager eventId={params.id as Id<"events">} currency={event.currency ?? "etb"} />
          </div>
        </div>
      </div>
    </div>
